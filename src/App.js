    ...
    return (
      ...
      <main className="cf pa2">
        <div className="fl w-100 w-50-ns ph2">
          <a href="https://rksnyder7.github.io/draftGuide/" target="_blank" className="pv2 grow db no-underline black">
        ...
        <div className="fl w-50 w-25-ns ph2">
          <a href="https://rksnyder7.github.io/travelPlanner/" target="_blank" className="no-underline pv2 grow db black">
                  <header class="bb b--black-70 pv4">
        ...
        <div className="fl w-50 w-25-ns ph2">
          <a href="https://rksnyder7.github.io/Preksway/" target="_blank" className="no-underline pv2 grow db black">
                  <header class="bb b--black-70 pv4">
